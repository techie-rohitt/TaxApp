...
export function VerdictCard({
  ...
  const accentColor = bothZero ? "var(--accent)" : winner === "new" ? "var(--new-regime)" : "var(--old-regime)";

  return (
    <div className="overflow-hidden rounded-[var(--radius-card)] border border-[var(--border)] bg-[var(--surface)] shadow-[0_1px_2px_rgba(0,0,0,0.04),0_12px_32px_-12px_rgba(0,0,0,0.1)]">
      <div className="h-1.5 w-full" style={{ backgroundColor: accentColor }} />
      <div className="p-6 text-center sm:p-8 md:p-12">
        <h1 className="text-[26px] font-semibold sm:text-[32px] md:text-[48px]">{heading}</h1>
